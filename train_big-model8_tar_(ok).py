...
def main():
    ...
    class FreezeEncoderCallback(TrainerCallback):
        ...
        def on_step_begin(self, args, state, control, **kwargs):
            ...
            if state.global_step == 0:
                ...
                print(f"❄️ Энкодер заморожен на первые {self.unfreeze_step} шагов.")
            ...
            if state.global_step >= self.unfreeze_step and not self.is_unfrozen:
                ...
                print(f"🔥 Шаг {state.global_step}: Энкодер разморожен. Начинаем полное дообучение.")
    ...
    trainer = Seq2SeqTrainer(
        ...
        callbacks=[callback, freeze_callback],
