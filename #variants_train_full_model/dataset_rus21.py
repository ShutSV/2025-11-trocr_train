"""
Webdataset для тренировки TROCR на кириллическом наборе картинок рукописного текста
"""
...
def check_tokenizer_dataset():
    ...
    print(f"При создании датасетов Символ: {test_char} | ID в процессоре: {char_id}. Размер словаря: {len(processor.tokenizer)}")
